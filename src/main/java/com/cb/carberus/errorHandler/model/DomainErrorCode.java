...
public enum DomainErrorCode implements ErrorCode {
    ...
    // Project
    PROJECT_NOT_FOUND("PROJECT_NOT_FOUND", 400),
    PROJECT_MEMBER_NOT_FOUND("PROJECT_MEMBER_NOT_FOUND", 400),
    PROJECT_NAME_ALREADY_EXIST("PROJECT_NAME_ALREADY_EXIST", 400),
    PROJECT_PREFIX_ALREADY_EXIST("PROJECT_PREFIX_ALREADY_EXIST", 400),
